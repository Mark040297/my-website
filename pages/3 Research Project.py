...
st.set_page_config(page_title="My Research Project", layout='wide', page_icon="👤")

st.markdown("[Smart Aquaponics System]"
            "(https://drive.google.com/file/d/16lRKfZ9Z0zc8GEHZVpya9Qvu4Y2FYlwa/view?usp=sharing)")
# footer
